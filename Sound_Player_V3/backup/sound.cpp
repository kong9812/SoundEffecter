...
// パンボリューム
//==============================================================
HRESULT SetPanVolume(IXAudio2Voice *inVoice, IXAudio2Voice *pDestinationVoice, float panVolume)
{
	HRESULT hr;
	float vol[4];
	...
	hr = inVoice->SetOutputMatrix(pDestinationVoice, GetWavFile()->fmt.fmtChannel, 2, vol);
...
// サブミックスボイスの作成
//==============================================================
IXAudio2SubmixVoice *SetSubmixVoice(void)
{
	IXAudio2SubmixVoice *submixVoice = NULL;
	xAudio2->CreateSubmixVoice(&submixVoice, GetWavFile()->fmt.fmtChannel, GetWavFile()->fmt.fmtSampleRate, NULL, 0);
